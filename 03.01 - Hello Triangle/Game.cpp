...
void Game::loadTriangle() {
	...
	glGenVertexArrays(1, &gVAO); //pide un buffer y pasa por referencia gVAO. si pidieramos el buffer mediante un array, pasaríamos un puntero *gVAO
	...
	glBufferData(GL_ARRAY_BUFFER, sizeof(vertexData), vertexData, GL_STATIC_DRAW); //si es una imagen estatica escribir GL_STATIC_DRAW si es dinamica escribir GL_DYNAMIC_DRAW
